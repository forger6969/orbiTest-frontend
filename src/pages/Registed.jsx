                            ...
                            <div className='bg-white w-full border border-gray-400 rounded-lg p-4'>
                                ...
                                <form className='flex flex-col gap-3' action="">
                                    ...
                                    <div className='flex flex-col gap-1 mt-5'>
                                        ...
                                        <input placeholder='Your password' id='pass' className='w-full  border-gray-300 h-10 rounded-lg pl-3 pb-1 font-medium focus:border-red-500 border-2 focus:outline-none ' type='password'
                                            value={password}
                                    ...
                                    <button type='button' onClick={() => console.log(email, password)} className='text-white bg-[#ef4343] rounded-lg py-2'>Continue</button>
                                </form>
