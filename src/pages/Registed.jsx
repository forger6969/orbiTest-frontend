...
const Registed = () => {
  ...
  const loginRequest = async () => {
    if (!isEmailValid) {
      showToast("Email must end with @gmail.com", "warning");
      return;
    }
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative z-10">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl p-8 border border-slate-200/60 shadow-xl shadow-slate-900/5 relative overflow-hidden">
            <div className="space-y-6">
              {/* Google Button */}
              <button
                type="button"
                onClick={handleGoogleSignIn}
                className="w-full py-3.5 px-4 rounded-2xl border border-slate-200 bg-white hover:bg-slate-50 flex items-center justify-center gap-3 transition-all font-bold text-slate-700 hover:border-slate-300 hover:shadow-sm group"
              >
                <svg
              ...
              >
                ...
                <button
                  ...
                  className={`
                    ...
                    transition-all font-bold text-sm shadow-lg
                    ${
                      isFormValid
                        ? "bg-qizil1 text-white hover:bg-qizil2 shadow-qizil1/20 hover:shadow-qizil1/30 scale-100 active:scale-95"
          ...
          <div className="text-center mt-8">
            <p className="text-slate-500 font-medium text-sm">
              ...
              <Link
                to="/SingUp"
                className="text-qizil1 font-bold hover:underline underline-offset-4 decoration-2"
              >
                Create Account
              </Link>
            </p>
